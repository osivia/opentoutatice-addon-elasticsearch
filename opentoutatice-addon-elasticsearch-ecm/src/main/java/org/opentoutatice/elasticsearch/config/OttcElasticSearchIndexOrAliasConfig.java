...
public class OttcElasticSearchIndexOrAliasConfig extends ElasticSearchIndexConfig implements Serializable, Cloneable {
	...
	public boolean mustCreate() {
		return  aliasConfigured() ? false : this.create;
	}
	...
	public OttcElasticSearchIndexOrAliasConfig clone() {
		...
		try {
			...
			clone = new OttcElasticSearchIndexOrAliasConfig(isEnabled(), getName(), getRepositoryName(), getType(),
					mustCreate(), getSettings(), getMapping(), getExcludes(), getIncludes());
		}

		// Deep copy (mutable classes)
		clone.setExcludes(getExcludes().clone());
		clone.setIncludes(getIncludes().clone());
	 ...
	 * @param includes
	 */
	public OttcElasticSearchIndexOrAliasConfig(boolean isEnabled, String name, String repositoryName, String type,
			boolean create, String settings, String mapping, String[] excludes, String[] includes) {
		super();
