...
public class ZeroDownTimeReIndexingBadInitialFormerAliasTest {

    private static final Log log = LogFactory.getLog(ZeroDownTimeReIndexingBadInitialFormerAliasTest.class);
