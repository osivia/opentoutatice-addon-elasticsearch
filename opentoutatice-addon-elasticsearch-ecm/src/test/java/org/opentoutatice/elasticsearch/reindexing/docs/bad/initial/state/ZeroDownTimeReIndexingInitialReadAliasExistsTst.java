...
public class ZeroDownTimeReIndexingInitialReadAliasExistsTst {

    private static final Log log = LogFactory.getLog(ZeroDownTimeReIndexingInitialReadAliasExistsTst.class);
